    ...
    <div className="outer">
        ...
        <div className="container">
          <div className="content">
            ...
            <div className="titles-container">
              <div>
                ...
                <div>
                  <h1 className={`name-title htext ${dark? 'dark' : ''}`}>Akshay Sivaraman</h1>
                  <div>
          ...
          <div className={`paragraph-div htext ${dark? 'dark' : ''}`}>
              <p>
              I'm Akshay Sivaraman, a computer science undergrad with a passion for technology. My journey in the world of computers began with curiosity and has grown into a deep-seated interest in solving real-world problems through code.
              </p>
              <p>
